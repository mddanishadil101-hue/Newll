let shouldBypass = false;
    ...
    if(shouldBypass){
      try{ await pool.query('INSERT INTO bypass_logs (code,referrer,ip_address,user_agent) VALUES ($1,$2,$3,$4)', [code, ref === 'direct' ? null : ref, ip || null, ua || null]); }catch(e){ console.error('log bypass', e); }
